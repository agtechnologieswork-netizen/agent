...
class FSMApplication:
    ...
    def base_execution_plan(cls) -> str:
        return "\n".join(
            [
                ...
                "",
                "The result application will be based on PHP and Laravel framework. Persistent data will be stored in Postgres.",
    ...
    async def make_states(
        ...
        app_actor = LaravelActor(
            ...
            beam_width=3,
            max_depth=100,  # Increased from 30 to allow more iterations for complex apps
...
async def main(user_prompt="Add header to welcome page that says Hello World"):
    async with dagger.Connection(
        ...
        if fsm_app.maybe_error():
            ...
            await fsm_app.apply_changes("Change the header to say App is generated")
