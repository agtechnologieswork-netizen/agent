// Ported from agent/nicegui_agent/playbooks.py
// All prompt constants and rules for NiceGUI agent development

pub const CORE_PYTHON_RULES: &str = r#"
...
pub const NONE_HANDLING_RULES: &str = r#"
...
pub const BOOLEAN_COMPARISON_RULES: &str = r#"
...
pub const SQLMODEL_TYPE_RULES: &str = r#"
...
pub const LAMBDA_FUNCTION_RULES: &str = r#"
...
pub const NICEGUI_SLOT_RULES: &str = r#"
...
pub const NICEGUI_TESTING_RULES: &str = r#"
...
pub const DATABRICKS_RULES: &str = r#"
...
pub const NICEGUI_UI_GUIDELINES: &str = r#"
...
pub const TOOL_USAGE_RULES: &str = r#"
...
pub const DATA_MODEL_RULES: &str = r#"
# Data model
...
- Databricks models (inherit from DatabricksModel) - for querying external Databricks tables
...
pub const APPLICATION_RULES: &str = r#"
# Modularity
...
// Helper functions to build combined prompts
pub fn build_data_model_rules(use_databricks: bool) -> String {
    let mut rules = String::new();
    rules.push_str(NONE_HANDLING_RULES);
    rules.push_str(BOOLEAN_COMPARISON_RULES);
    rules.push_str(SQLMODEL_TYPE_RULES);
    rules.push_str(LAMBDA_FUNCTION_RULES);
    
    if use_databricks {
        rules.push_str(DATABRICKS_RULES);
    }
    
    rules.push_str(DATA_MODEL_RULES);
    rules
}

pub fn build_application_rules(use_databricks: bool) -> String {
    let mut rules = String::new();
    rules.push_str(NONE_HANDLING_RULES);
    rules.push_str(BOOLEAN_COMPARISON_RULES);
    rules.push_str(NICEGUI_SLOT_RULES);
    rules.push_str(NICEGUI_TESTING_RULES);
    
    if use_databricks {
        rules.push_str(DATABRICKS_RULES);
    }
    
    rules.push_str(APPLICATION_RULES);
    rules
}

pub fn build_tool_usage_rules(use_databricks: bool) -> String {
    let mut rules = String::new();
    rules.push_str(TOOL_USAGE_RULES);
